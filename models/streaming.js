...
class ChannelData {
    /**
     * Creates an instance of ChannelData.
     * @param {Object} param0
     * @param {string} param0.streamId - Unique identifier for the streaming session
     * @param {string} param0.streamType - Type of stream (Informative, Streaming, Final)
     * @param {number} param0.streamSequence - Sequence number to track the order of chunks
     */
